...
ALLOWED_HOSTS = env.list("DJANGO_ALLOWED_HOSTS", default=["jeremiahedavid.space", "www.jeremiahedavid.space"])
...
DEFAULT_FROM_EMAIL = env(
    ...
    default="Jeremiah David <noreply@jeremiahedavid.space>",
)
...
SPECTACULAR_SETTINGS["SERVERS"] = [  # noqa F405
    {"url": "https://jeremiahedavid.space", "description": "Production server"}
]
# Your stuff...
# ------------------------------------------------------------------------------
if not PRODUCTION:
